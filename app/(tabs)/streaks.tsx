...
export default function StreaksScreen() {
    ...
    useEffect(() => {
      ...
      const fetchHabits = async () => {
        ...
        const getStreakData = (habitId: string): StreakData => {
            const habitCompletions = completedHabits?.filter((c) => c.habit_id === habitId).sort(
                (a, b) => 
    ...
    <View style={styles.container}>
        <Text style={styles.title} variant="headlineSmall">Habits Streaks</Text>
